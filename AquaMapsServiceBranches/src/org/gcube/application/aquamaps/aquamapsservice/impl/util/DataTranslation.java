...
public class DataTranslation {
	...
	public static HashMap<org.gcube.application.aquamaps.stubs.dataModel.Resource.Type,String> completeResourceListQuery = new HashMap<org.gcube.application.aquamaps.stubs.dataModel.Resource.Type, String>();
	...
	static{
		...
		completeResourceListQuery.put(org.gcube.application.aquamaps.stubs.dataModel.Resource.Type.HCAF, "select * from Meta_HCaf");
		completeResourceListQuery.put(org.gcube.application.aquamaps.stubs.dataModel.Resource.Type.HSPEC, "select Meta_HSPEC.*, Meta_HCaf.title AS sourceHCafName, Meta_HSpen.title AS sourceHSpenName from Meta_HSPEC, Meta_HSpen, Meta_HCaf where Meta_HSPEC.sourceHCafId = Meta_HCaf.searchId AND Meta_HSPEC.sourceHSpenId = Meta_HSpen.searchId");
		completeResourceListQuery.put(org.gcube.application.aquamaps.stubs.dataModel.Resource.Type.HSPEN, "select * from Meta_HSpen");
	}
