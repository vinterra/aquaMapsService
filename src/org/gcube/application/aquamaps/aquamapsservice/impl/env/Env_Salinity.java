...
public class Env_Salinity extends EnvEngine {
	...
	public void re_computes(Species species, List<Cell> goodCells) throws Exception {
		...
		String fld;
		if (species.getFieldbyName(Species.Tags.Layer).equals("b")) {
			fld = "SalinityBMean";			
...
*/
		...
		species.getFieldbyName(Species.Tags.SalinityMin).setValue(""+this.salinMin);
		species.getFieldbyName(Species.Tags.SalinityMax).setValue(""+this.salinMax);
		species.getFieldbyName(Species.Tags.SalinityPrefMin).setValue(""+this.salinPMin);
		species.getFieldbyName(Species.Tags.SalinityPrefMax).setValue(""+this.salinPMax);
	}
}
