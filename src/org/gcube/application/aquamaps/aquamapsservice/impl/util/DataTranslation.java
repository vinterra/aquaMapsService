...
//	public static HashMap<ResourceType,String> completeResourceListQuery = new HashMap<ResourceType, String>();
//
...
//	
//		completeResourceListQuery.put(ResourceType.HCAF, "select * from Meta_HCaf");
//		completeResourceListQuery.put(ResourceType.HSPEC, "select Meta_HSPEC.*, Meta_HCaf.title AS sourceHCafName, Meta_HSpen.title AS sourceHSpenName from Meta_HSPEC, Meta_HSpen, Meta_HCaf where Meta_HSPEC.sourceHCafId = Meta_HCaf.searchId AND Meta_HSPEC.sourceHSpenId = Meta_HSpen.searchId");
//		completeResourceListQuery.put(ResourceType.HSPEN, "select * from Meta_HSpen");
//	}
//	
