...
public class AquaMapsObject {
	...
	private Map<String,Map<String,Perturbation>> envelopCustomization=new HashMap<String, Map<String,Perturbation>>();
	...
	private List<Field> weights=new ArrayList<Field>();
	...
	public Map<String, Map<String, Perturbation>> getEnvelopCustomization() {
		return envelopCustomization;
	}
	public void setEnvelopCustomization(
			Map<String, Map<String, Perturbation>> envelopCustomization) {
		this.envelopCustomization = envelopCustomization;
	}
	...
	public List<Field> getWeights() {
		return weights;
	}
	public void setWeights(List<Field> weights) {
	...
	public String toXML(){
		...
		for(String specId:envelopCustomization.keySet()){
			profileBuilder.append("<"+Species.Tags.ID+">"+specId+"</"+Species.Tags.ID+">");
			profileBuilder.append("<Customizations>");
			for(String fieldName:envelopCustomization.get(specId).keySet()){
				profileBuilder.append("<Customization>");
				profileBuilder.append("<FieldName>"+fieldName+"</FieldName>");
				profileBuilder.append("<Type>"+envelopCustomization.get(specId).get(fieldName).getType()+"</Type>");
				profileBuilder.append("<Value>"+envelopCustomization.get(specId).get(fieldName).getPerturbationValue()+"</Value>");
				profileBuilder.append("</Customization>");
			}
			profileBuilder.append("</Customizations>");
		}
		...
		profileBuilder.append("<Weights>");
			for(Field field:weights) profileBuilder.append(field.toXML());
		profileBuilder.append("</Weights>");
